...
public class MainActivity5  extends BaseActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post5);
            ...
            textcal = (TextView) findViewById(R.id.textView5);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot areaSnapshot : dataSnapshot.getChildren()) {
                    if(uid.equalsIgnoreCase(currentUserEmailfinal)){
                        ...
                        ArrayAdapter<String> areasAdapter = new ArrayAdapter<String>(MainActivity5.this, android.R.layout.simple_spinner_item, areas);
