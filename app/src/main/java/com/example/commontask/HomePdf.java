...
public class HomePdf  extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_home_pdf, container, false);
    ...
    public class CreatingPdf extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
         ...
         path = Environment.getExternalStorageDirectory().getAbsolutePath() + HomePdf.this.getString(R.string.pdf_dir);
            ...
            path = path + filename + HomePdf.this.getString(R.string.pdf_ext);
