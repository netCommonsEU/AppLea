...
public class NewPostActivity2 extends BaseActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot areaSnapshot : dataSnapshot.getChildren()) {
                    if(uid.equalsIgnoreCase(currentUserEmailfinal)){
                        ...
                        ArrayAdapter<String> areasAdapter = new ArrayAdapter<String>(NewPostActivity2.this, android.R.layout.simple_spinner_item, areas);
     ...
     /*   currentUserEmail1 = EmailEncoding.commaEncodePeriod(mFirebaseAuth.getCurrentUser().getEmail());
        mCurrentUserDatabaseReference = mFirebaseDatabase
                .getReference().child(Constants.USERS_LOCATION
                        + "/" + currentUserEmail1);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(userTestEmail.equalsIgnoreCase(currentUserEmail1)){
                    ...
                    String areaName1 = ((HashMap) dataSnapshot.getValue()).get("kind").toString();
                    String tmp = areaName1.replace(" ", "");
                    String[] tokens = tmp.split(",");
                    for(int i=0;i<tokens.length;i++){
                        areas1.add(tokens[i]);
                    }
                    ArrayAdapter<String> areasAdapter1 = new ArrayAdapter<String>(NewPostActivity2.this, android.R.layout.simple_spinner_item, areas1);
                    areasAdapter1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    spinner3.setAdapter(areasAdapter1);
    ...
    private void submitPost() {
        ...
        final String body4 = spinner5.getText().toString();
