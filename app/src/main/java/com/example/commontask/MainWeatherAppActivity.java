...
import com.example.commontask.utils.PressureWithUnit;
...
public class MainWeatherAppActivity extends WeatherBaseActivity
    ...
    FloatingActionButton.OnClickListener fabListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            CurrentWeatherDbHelper currentWeatherDbHelper = CurrentWeatherDbHelper.getInstance(getApplicationContext());
            ...
            String sunrise;
            String sunset;
            description = Utils.getWeatherDescription(getApplicationContext(), currentLocation.getLocaleAbbrev(), weather);
            sunrise = Utils.unixTimeToFormatTime(getApplicationContext(), weather.getSunrise(), currentLocation.getLocale());
            sunset = Utils.unixTimeToFormatTime(getApplicationContext(), weather.getSunset(), currentLocation.getLocale());
    ...
    private void updateCurrentLocationAndButtonVisibility() {
        currentLocation = locationsDbHelper.getLocationById(AppPreference.getCurrentLocationId(MainWeatherAppActivity.this));
        if (currentLocation == null) {
            currentLocation = locationsDbHelper.getLocationByOrderId(0);
        }
