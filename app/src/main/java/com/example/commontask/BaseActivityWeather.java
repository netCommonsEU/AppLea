...
public class BaseActivityWeather extends AppCompatActivity {

    private final String TAG = "BaseActivityWeather";
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    switch (item.getItemId()) {
                        ...
                        case R.id.nav_menu_current_weather:
                            startActivity(new Intent(BaseActivityWeather.this, MainWeatherAppActivity.class));
                            break;
                        case R.id.nav_menu_graphs:
                            createBackStack(new Intent(BaseActivityWeather.this,
