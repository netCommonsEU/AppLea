...
import com.example.commontask.easyvideoplayer.EasyVideoCallback;
import com.example.commontask.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(com.example.commontask.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(com.example.commontask.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(com.example.commontask.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
