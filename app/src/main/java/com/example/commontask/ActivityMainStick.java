...
public class ActivityMainStick extends MyActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_main_stick);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        this.menu = menu;
        getMenuInflater().inflate(R.menu.menu_main_stick, menu);
