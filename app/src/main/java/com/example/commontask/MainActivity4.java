...
import com.example.commontask.utils.*;
...
public class MainActivity4 extends BaseActivity implements MaterialSpinner.OnItemSelectedListener {
    ...
    MaterialSpinner spinnerchemistry,spinnerkind;
    View view;
    ...
    int result;
    TextView textView;
    ArrayAdapter<String> adapterinsect,adaptermikitas,adapterdiafilika,adapterastheneia;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_post4);

        mView=MainActivity4.this;
        ...
        String[] list2 = getResources().getStringArray(R.array.spray_type);
        ...
        fab = (FloatingActionButton) findViewById(R.id.fab);
         ...
         spinnerchemistry=(MaterialSpinner) findViewById(R.id.spinner);
         spinnerkind=(MaterialSpinner) findViewById(R.id.spinner1);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot areaSnapshot : dataSnapshot.getChildren()) {
                    if(uid.equalsIgnoreCase(currentUserEmailfinal)){
                        ...
                        ArrayAdapter<String> areasAdapter = new ArrayAdapter<String>(MainActivity4.this, android.R.layout.simple_spinner_item, areas);
        ...
        spinnerkind.setAdapter(adapter2);
    ...
    public void onItemSelected(MaterialSpinner view, int position, long id, Object item) {
        ...
        ArrayAdapter<String>  adapterchemistry = new ArrayAdapter<String>(this,
                android.R.layout.simple_dropdown_item_1line, state);

        spinnerchemistry.setAdapter(adapterchemistry);
    }
    ...
    private void submitPost() {
        ...
        final String body4 = spinnerkind.getText().toString()+ " "+spinnerchemistry.getText().toString()+ " " + textView.getText().toString() + " "+ spinner5.getText().toString();
