...
import com.example.commontask.model.TAG_M_FORECAST_DATA
    ...
    init {
        ...
        try {
            ...
            if (listAddresses != null && listAddresses.size > 0) {
                ...
                else if (listAddresses[0].subAdminArea != null) {
