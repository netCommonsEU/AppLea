                ...
                for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(length == 1){
                                mLikesString = "Like " + splitUsers[0];
                            }
                            else if(length == 2){
                                mLikesString = "Like " + splitUsers[0]
                                        + " and " + splitUsers[1];
                                ...
                                mLikesString = "Like" + splitUsers[0]
                                        + ", " + splitUsers[1]
                                        + ", " + splitUsers[2]
                                        + " and " + (splitUsers.length - 3) + " with others";
                            }
...
///
    ...
    private void setupWidgets(){
        ...
        int milliseconds= Integer.parseInt(timestampDiff);
        ...
        if(hours>0){
            if(hours==1){
                mTimestamp.setText("1 hour  ago");
            }
            else if(hours<24){
                mTimestamp.setText(String.valueOf(hours)+ " hours ago");
            }
            else{

                if(days==1){
                    mTimestamp.setText(" 1 ημέρα πρίν");

                }
                else
                    mTimestamp.setText(String.valueOf(days)+" days ago");
            }
        }
        else {
            if (minutes==0){
                mTimestamp.setText("Right Now");
            }
            else if(minutes==1){
                mTimestamp.setText("1 λεπτό πρίν");
            }
            else {
                mTimestamp.setText(String.valueOf(minutes)+" minutes ago");
            }
        }
        ...
        if(mPhoto.getComments().size() > 0){
            mComments.setText("See the " + mPhoto.getComments().size() + " comments");
        }else{
            mComments.setText("");
        }
