...
public class AppAlarmService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, final int startId) {
        ...
        if ("com.example.commontask.action.START_ALARM_SERVICE".equals(intent.getAction())) {
            ...
            alarmStarted = false;
            setAlarm();
        } else if ("com.example.commontask.action.START_LOCATION_WEATHER_ALARM".equals(intent.getAction())) {
    ...
    private PendingIntent getPendingIntent(boolean autoLocation) {
        Intent intent = new Intent("com.example.commontask.action.START_LOCATION_WEATHER_ALARM");
