...
public class AppAlarmService extends AbstractCommonService {
    ...
    public int onStartCommand(Intent intent, int flags, final int startId) {
        ...
        if ("com.example.commontask.action.START_ALARM_SERVICE".equals(intent.getAction())) {
            setAlarm();
        } else if ("com.example.commontask.action.RESTART_ALARM_SERVICE".equals(intent.getAction())) {
            alarmStarted = false;
            setAlarm();
        } else if ("com.example.commontask.action.RESTART_NOTIFICATION_ALARM_SERVICE".equals(intent.getAction())) {
            scheduleNextNotificationAlarm();
        } else if ("com.example.commontask.action.START_LOCATION_WEATHER_ALARM_AUTO".equals(intent.getAction())) {
        ...
        } else if ("com.example.commontask.action.START_LOCATION_WEATHER_ALARM_REGULAR".equals(intent.getAction())) {
    ...
    private static PendingIntent getPendingIntent(Context context, boolean autoLocation) {
        Intent intent;
        if (autoLocation) {
            intent = new Intent("com.example.commontask.action.START_LOCATION_WEATHER_ALARM_AUTO");
        } else {
            intent = new Intent("com.example.commontask.action.START_LOCATION_WEATHER_ALARM_REGULAR");
        }
