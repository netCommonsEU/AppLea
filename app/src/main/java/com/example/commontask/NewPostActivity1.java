...
public class NewPostActivity1  extends BaseActivity{
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot areaSnapshot : dataSnapshot.getChildren()) {
                    if(uid.equalsIgnoreCase(currentUserEmailfinal)){
                        ...
                        ArrayAdapter<String> areasAdapter = new ArrayAdapter<String>(NewPostActivity1.this, android.R.layout.simple_spinner_item, areas);
    ...
    private void submitPost() {
        ...
        final String body4 = item3 + " "+ spinner5.getText().toString();
