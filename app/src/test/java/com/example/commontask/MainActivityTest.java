...
import com.example.commontask.test.shadows.ShadowLinearLayoutManager;
import com.example.commontask.test.shadows.ShadowRecyclerView;
import com.example.commontask.test.shadows.ShadowViewPager;
...
public class MainActivityTest {
    ...
    private MainActivityCalendar activity;
    ...
    public void setUp() {
        ...
        toggle = (CheckedTextView) activity.findViewById(R.id.toogle);
    ...
    public void testQueryDay() {
        ...
        ((MainActivityCalendar.AgendaCursorAdapter) agendaView.getAdapter())
    ...
    static class TestMainActivity extends MainActivityCalendar {
        @Override
